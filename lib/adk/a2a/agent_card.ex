defmodule ADK.A2A.AgentCard do
  @moduledoc """
  Generates an A2A Agent Card from an ADK agent spec.
  ...
  @doc """
  Generate an Agent Card map from an ADK agent spec.
  ...
  ## Examples
      ...
      "helper"
  """
  @spec from_agent(map(), keyword()) :: map()
  ...
  defp build_skills(%{config: %{tools: tools}}) when is_list(tools) and tools != [] do
