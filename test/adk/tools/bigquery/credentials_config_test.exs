defmodule ADK.Tool.BigQuery.CredentialsConfigTest do
  use ExUnit.Case, async: true

  alias ADK.Tool.BigQuery.CredentialsConfig

  describe "BigQueryCredentialsConfig validation" do
    test "test_valid_credentials_object_auth_credentials" do
      # Simulate a mock auth credentials object that doesn't have client_id/secret fields
    ...
    test "test_valid_credentials_object_oauth2_credentials" do
      # Simulate a mock oauth2 credentials object with client_id, client_secret, scopes
      oauth2_creds = %{
