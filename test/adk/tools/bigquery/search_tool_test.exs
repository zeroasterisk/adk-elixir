defmodule ADK.Tool.BigQuery.SearchToolTest do
  ...
  describe "search_catalog" do
    ...
    test "search_catalog_no_project_id" do
      result =
        SearchTool.search_catalog("test", "", @mock_credentials, @mock_settings, location: "us")
    ...
    test "search_catalog_query_construction multi_type_filter" do
      ...
      assert query =~
               "(p) AND projectid=\"test-project\" AND (type=\"TABLE\" OR type=\"DATASET\") AND system=BIGQUERY"
    end
    ...
    test "search_catalog_no_app_name" do
      ...
      result =
        SearchTool.search_catalog("test", "test-project", @mock_credentials, %{}, mock_return: [])
    ...
    test "search_catalog_multi_project_filter_semantic" do
      ...
      assert query =~
               "(What datasets store user profiles?) AND (projectid=\"user-data-proj\" OR projectid=\"shared-infra-proj\") AND type=\"DATASET\" AND system=BIGQUERY"
    ...
    test "search_catalog_natural_language_semantic" do
      ...
      assert query ==
               "(Find tables about football matches) AND projectid=\"sports-analytics\" AND system=BIGQUERY"
    ...
    test "search_catalog_settings_location" do
      SearchTool.search_catalog(
        "test",
        "test-project",
        @mock_credentials,
        %{application_name: "test-app", location: "eu"},
        mock_return: [],
        track_query: true
      )
